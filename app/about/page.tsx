        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-6">From vision to impact</h2>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary">What drives us</h2>
          </motion.div>
                ...
                <div className="card p-8 h-full">
                  <div className="flex items-start gap-6">
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#6366f1] to-[#a855f7] flex items-center justify-center flex-shrink-0">
                      <value.icon className="w-7 h-7 text-text-primary" />
                    </div>
                    <div>
      ...
      <section className="py-24 bg-[#111113]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-text-primary">Meet our leaders</h2>
          </motion.div>
              ...
              <motion.div key={member.name} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }}>
                <div className="card p-6 text-center">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#6366f1] to-[#a855f7] mx-auto mb-4 flex items-center justify-center">
                    <span className="text-2xl font-bold text-text-primary">{member.initials}</span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="card p-12 lg:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-bold text-text-primary mb-6">Ready to work with us?</h2>
